...
const PassengersForm = forwardRef(
  ({ defaultValues, setContactInfos, isKeyboardOpened }, ref) => {
    ...
    useImperativeHandle(ref, () => ({
      ...
      reset() {
        methods.reset({ FirstName: "", LastName: "", BirthDate: null });
      },
    }));
        ...
        <form className="form" onSubmit={handleSubmit}>
          <section className={classes.boxField}>
            ...
            <Controller
              ...
              as={TextField}
              onFocusCapture={() => isKeyboardOpened(true)}
              onBlurCapture={() => isKeyboardOpened(false)}
